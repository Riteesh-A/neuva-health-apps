...
export function PrescriptionUpload({ user }: { user: any }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center md:min-h-screen p-4 sm:p-6 md:p-8">
      <div className="bg-white border rounded-lg shadow-lg p-4 sm:p-6 md:p-8 w-full max-w-md mx-auto">
        <h2 className="text-2xl sm:text-3xl font-bold mb-2 sm:mb-4 text-center text-primary">Upload Your Prescription</h2>
        <form onSubmit={handleSubmit} className="flex flex-col items-center w-full space-y-5">
          ...
          <div className="w-full mb-4 sm:mb-6">
            <Label className="block mb-1 sm:mb-2 text-base sm:text-lg font-medium text-gray-700" htmlFor="prescription">
            ...
            <div className={cn(
              ...
              <label htmlFor="prescription" className="cursor-pointer">
                <div className="flex flex-col items-center">
                  <svg className="w-8 h-8 sm:w-10 sm:h-10 text-gray-400 mb-1 sm:mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"></path>
                  </svg>
                  <p className="text-xs sm:text-sm text-gray-500">Click to upload or drag and drop</p>
                  <p className="text-xs text-gray-400 mt-0.5 sm:mt-1">PDF, JPG, JPEG, PNG</p>
                </div>
              </label>
          ...
          {submitted && (
            <div className="mt-6 p-4 bg-green-100 border border-green-300 rounded-md w-full">
              <p className="text-green-800 font-medium text-center">Prescription submitted successfully!</p>
              <p className="mt-2 text-sm text-gray-700 text-center">
                Please schedule your consultation by clicking below.
              </p>
              <Button
      ...
      <p className="text-xs sm:text-sm text-gray-500 mt-4 sm:mt-6 text-center">We appreciate your business!</p>
    </div>
  );
}
