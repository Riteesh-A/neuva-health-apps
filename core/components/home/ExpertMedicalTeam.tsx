    ...
    return (
        <>
            ...
            <div className={cn(hankenGrotesk.className, "container mx-auto py-12")}>
                ...
                <p className=" text-[18px] text-center mt-2 mb-8 px-96 font-light">Our board-certified physicians specialize in men's health and provide personalized care tailored to your specific needs.</p>
                ...
                <div className="text-center mt-8">
                    <button className="border font-bold text-[18px] border-gray-500 text-gray-500 py-3 px-5 rounded-full">Book a Consultation</button>
                </div>
            </div>
        </>
    );
