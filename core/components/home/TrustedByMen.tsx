...
const testimonials = [
    { quote: "The online consultation was professional and discreet. The doctor was knowledgeable and helped me understand my options.", name: "Rajesh K.", location: "32, Bangalore" },
    { quote: "I was hesitant to seek help, but Neuva made the process comfortable. The medication has made a significant difference.", name: "Vikram S.", location: "41, Mumbai" },
    { quote: "The assessment was easy to complete, and I got my prescription the same day. The quality of the medication is excellent.", name: "Arjun T.", location: "35, Delhi" },
    { quote: "I was hesitant to seek help, but Neuva made the process comfortable. The medication has made a significant difference.", name: "Vikram S.", location: "41, Mumbai" },
    { quote: "The assessment was easy to complete, and I got my prescription the same day. The quality of the medication is excellent.", name: "Arjun T.", location: "35, Delhi" },
    { quote: "The assessment was easy to complete, and I got my prescription the same day. The quality of the medication is excellent.", name: "Arjun T.", location: "35, Delhi" }
];
...
const TrustedByMen: React.FC = () => {
    return (
        <div className={cn(hankenGrotesk.className, "container mx-auto py-12 overflow-hidden mb-[450px]")}>
            ...
            <div className="absolute w-[99vw] overflow-hidden left-1/2 right-1/2 -ml-[49.5vw] -mr-[49.5vw] space-y-6 ">
                ...
                <div className="w-full flex space-x-6 animate-scroll-left">
                    {[...testimonials, ...testimonials].map((testimonial, index) => (
                        <div key={index} className="bg-[#E3EDFB] p-6 rounded-lg w-80 flex-shrink-0">
