            ...
            <div className="container mx-auto flex justify-between items-start">
                <div className="flex flex-col space-y-4">
                    <div className="flex items-center space-x-2">
                        <img src="/icons/neuva_logo_small_transparent.png" alt="Neuva Health" className="h-10" />
                    </div>
                ...
                <div className="flex flex-col space-y-4">
                    ...
                    <a href="#" className="text-gray-600 hover:text-gray-800">Press</a>
                ...
                <div className="flex flex-col space-y-2">
                    <h4 className="font-semibold text-gray-800">Subscribe to our Newsletter</h4>
                    <p className="text-gray-600">Stay updated with our latest products and offers.</p>
                    <div className="flex space-x-2">
                        <input type="email" placeholder="Email address" className="px-4 py-2 bg-[#E0E1E2] border border-gray-300 rounded-full focus:outline-none" />
                        <button className="bg-white text-gray-600 border border-gray-300 px-4 py-2 rounded-full">Subscribe</button>
                    </div>
                </div>
            </div>
        </footer>
